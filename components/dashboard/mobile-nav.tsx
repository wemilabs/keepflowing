    ...
    <Sheet>
      ...
      <SheetContent>
        <SheetHeader className="border-b">
          ...
          <Badge
            variant="outline"
            className="bg-green-100 dark:bg-green-950 text-green-600 dark:text-green-400 hover:bg-green-100 dark:hover:bg-green-950 rounded-md px-1.5 py-0 mt-1 text-sm block relative -bottom-2 -rigth-4"
          >
            Free
          </Badge>
        </SheetHeader>
